...
export default function AdminRequestPage() {
    ...
    const [privateProfiles, setPrivateProfiles] = useState<Map<string, any>>(new Map());
    const [loading, setLoading] = useState(false);
    const [hasMore, setHasMore] = useState(true);

    const { getAllAccepted, getProfilebyUID, setMatchAdmin, getPrivatebyUID } = useAuth();
    ...
    const handleMatchClick = async (brother: UserPrivate, sister: UserPrivate) => {
                    ...
                    return (
                        <div key={index} className="border p-2">
                            {profile1 && profile2 && privateProfile1 && privateProfile2 ? (
                                <div>
                                    <MatchProfilesComponent profile1={profile1} profile2={profile2} privateInfo1={privateProfile1} privateInfo2={privateProfile2} handleMatchClick={handleMatchClick} />
                                </div>
                            ) : (
